...
import com.example.memorygame.databinding.FragmentGameSuccessBinding
import com.example.memorygame.databinding.LayoutBottomDifficultySelectionBinding
import com.google.android.material.bottomsheet.BottomSheetDialog

class GameSuccessScreenFragment : Fragment() {
    private var _viewBinding: FragmentGameSuccessBinding? = null
    ...
    override fun onCreateView(
        ...
        _viewBinding = FragmentGameSuccessBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewBinding.buttonHome.setOnClickListener {
            findNavController().navigate(GameSuccessScreenFragmentDirections.actionGlobalDestLobby())
        }
    ...
    private fun onDifficultyLevelSelected(
        ...
        findNavController().navigate(GameSuccessScreenFragmentDirections.actionGlobalDestBoard())
        dialog.dismiss()
    }
}